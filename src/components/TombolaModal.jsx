...
export default function TombolaModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative w-full max-w-lg bg-white shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-beige">
          <div>
            ...
            <h2 className="font-serif text-xl text-terre leading-tight">Acheter des billets</h2>
          </div>
          <button
            onClick={onClose}
            aria-label="Fermer"
        ...
        <div className="flex-1 overflow-auto">
          <iframe
            ...
            allow="payment"
            scrolling="auto"
            src="https://www.helloasso.com/associations/ressources-association/evenements/evenement-ressources-tirage-public-de-la-tombola/widget"
            style={{ width: '100%', border: 'none', display: 'block', minHeight: '550px' }}
            onLoad={(e) => {
            ...
            title="Acheter des billets de tombola — HelloAsso"
          />
        </div>
        ...
        <div className="px-6 py-3 border-t border-beige bg-beige-light flex items-center gap-2">
          ...
          <p className="text-xs text-terre/40 leading-snug">
            Paiement sécurisé géré par HelloAsso. Les fonds soutiennent directement l'association Ressources.
          </p>
        </div>
      </div>
    </div>
