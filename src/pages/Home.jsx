...
function ImpactCounter({ value, suffix = '', label, index = 0 }) {
  ...
  return (
    <div ref={ref}
      className="flex flex-col items-center justify-center text-center px-4 py-10 md:py-14 group hover:bg-white transition-colors duration-300 cursor-default" style={{ backgroundColor: '#E5E4D5' }}>
