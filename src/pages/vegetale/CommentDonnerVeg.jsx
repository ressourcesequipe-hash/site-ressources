...
import { BrancheFeuilles, FeuillsDispers } from '../../components/BotanicalDecor'
  ...
  return (
    <Layout breadcrumbs={BREADCRUMBS}>
      ...
      <section style={{ backgroundColor: "#EDECCE", borderColor: 'rgba(108,124,73,0.1)' }} className="py-12 md:py-16 border-b relative overflow-hidden">
        <BrancheFeuilles className="absolute top-0 right-6 w-20 opacity-55 pointer-events-none select-none" />
        <FeuillsDispers className="absolute bottom-2 right-32 w-24 opacity-45 pointer-events-none select-none" />
