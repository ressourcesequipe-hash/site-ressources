...
export default function Tombola() {
  return (
    <Layout breadcrumbs={BREADCRUMBS}>
      <SEO
        title="Tombola solidaire — objectif 15 000 € pour la recyclerie Landes"
        description="Participez à la tombola solidaire de l'association Ressources le 17 octobre 2026. Objectif 15 000 € pour financer la recyclerie informatique dans les Landes (40560)."
      ...
      <section className="bg-kaki text-white py-12 md:py-16 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-white/65 max-w-xl leading-relaxed">
            Notre grande tombola de lancement. Tentez votre chance, soutenez
            directement la recyclerie informatique solidaire des Landes.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center bg-ocre-pale border border-ocre/20 p-10 mb-12">
            <p className="font-sans text-xs text-ocre font-semibold tracking-widest uppercase mb-3">Objectif</p>
            <p className="font-serif text-7xl text-ocre leading-none mb-2">15 000</p>
            <p className="font-sans text-xl text-terre/60">euros</p>
            <p className="text-sm text-terre/50 mt-2">pour financer l'équipement de l'association Ressources</p>
          </div>

          <div className="grid md:grid-cols-2 gap-10 mb-12">
            <div>
              <h2 className="font-serif text-2xl text-terre mb-4">À quoi servent les fonds ?</h2>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { num: '2', text: 'Venez à l\'événement le 17 octobre 2026 à Vielle-Saint-Girons' },
                  { num: '3', text: 'Participez au tirage au sort et tentez de remporter l\'un des lots' },
                  { num: '4', text: 'Votre achat finance directement l\'équipement de l\'association' },
                ].map(({ num, text }) => (
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/evenement-lancement-17-octobre-2026/" className="btn-ocre">
              Voir l'événement du 17 octobre
            </Link>
