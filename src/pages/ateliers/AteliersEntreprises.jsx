...
const FAQ = [
  ...
  { q: 'Un don de matériel est-il déductible ?', r: "L'association Ressources relève de l'intérêt général : un don de matériel ouvre droit à une réduction d'impôt de 60 % pour les entreprises. Attention toutefois, la valorisation retenue est la valeur nette comptable du bien — un parc entièrement amorti n'ouvre quasiment aucun droit. Contactez-nous pour examiner votre situation, ou consultez notre page mécénat." },
